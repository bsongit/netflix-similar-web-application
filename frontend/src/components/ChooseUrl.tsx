    ...
    return(
        <div className="modal" onClick={() => setWindowChosseUrl(!windowChosseUrl)}>
            ...
            <div className="choose-url">
                <button className={props.movieContext.url1? 'bg-green' : 'bg-gray'} disabled={props.movieContext.url1?  false : true}onClick={() => props.selectMovie(props.movieContext.url1)} >Player #1🎞</button>
