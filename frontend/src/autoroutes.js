...
function routeGenerator(routes) {
    ...
    contentFile +=  `<url>\n`;
    contentFile +=  `<loc>http://www.filmes-temporadas-online.ml/</loc>\n`;
    contentFile += `<lastmod>2021-01-20T15:59:52+00:00</lastmod>\n` ;
    contentFile += `</url>\n` ;
    routes?.map(route => {
      contentFile += route.url? `<url>\n` : ''
      contentFile += route.url? `<loc>http://www.filmes-temporadas-online.ml/${route.url}</loc>\n` : ''
      contentFile += route.url? `<lastmod>2021-01-20T15:59:52+00:00</lastmod>\n` : ''
      contentFile += route.url? `</url>\n` : ''
      contentFile += route.url1? `<url>\n` : ''
      contentFile += route.url1? `<loc>http://www.filmes-temporadas-online.ml/assistir/${route.url1}</loc>\n` : ''
